...
class ROIselector(object):
    ...
    def __init__(self,ax,imgplot,img_slider,saveData,saveScan):
        ...
        self.ROI =  RectangleSelector(ax, self.onselectfun, drawtype='box', interactive=True, useblit=False)
...
def keyboard_selector(event):
    ...
    if event.key in ['1']: 
        ...
        ROI2.ROI.set_active(False)
        ROI1.ROI.set_active(True)
    if event.key in ['2']: 
        print('ROI2 activated')
        ROI1.ROI.set_active(False)
        ROI2.ROI.set_active(True)
