...
def ROIlineupdate(ROI):
    ...
    plt.setp(ROIplot4, xdata=scan.ROIlist[0].L)
    plt.setp(ROIplot5, ydata=scan.ROIlist[4].saveInt)
    plt.setp(ROIplot5, xdata=scan.ROIlist[0].L)
    plt.setp(ROIplot6, ydata=scan.ROIlist[5].saveInt)
    plt.setp(ROIplot6, xdata=scan.ROIlist[0].L)
    plt.setp(ROIplot7, ydata=scan.ROIlist[6].saveInt)
    plt.setp(ROIplot7, xdata=scan.ROIlist[0].L)
...
class ROIselector(object):
    ...
    def updatedata(self):
        ...
        #ROI1.ROI.center
        #ROI1.ROI.draw_shape([100,200,80,150])
    def storedata(self):
...
#        ROI3.storedata()
    ...
    if event.key in ['r']:
        img_slider.set_val(img_slider.val-1)
        update(img_slider.val)  
#        a=scan.ROIlist[0].saveROI[img_slider.val,:]
#        ROI1.ROI.draw_shape(a)
        ROI1.ROI.draw_shape(int(scan.ROIlist[0].saveROI[img_slider.val,:]))
