...
#Intplot=ax123.plot(Intpixel,'ko--')
...
def updateIntplot():
    if Image.initialized == True:
        Intpixel=scan.selectorlist[Image.ActiveROI].IntROI
        ...
        BKGRline1=scan.selectorlist[Image.ActiveROI].BKGRline1
        BKGRline2=scan.selectorlist[Image.ActiveROI].BKGRline2        
        ax123.cla()
