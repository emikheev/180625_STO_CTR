...
def ROIlineupdate():
    ...
    ax5.set_ylim(0.1,ROIIntline.max()*2)
...
#        toggle_selector.RS.set_active(False)
    #if event.key in ['1', 'a'] and not toggle_selector.ROISelector1.active:
    if event.key in ['1', 'a']:
    ...
    #if event.key in ['2', 'b'] and not toggle_selector.ROISelector2.active:
    if event.key in ['2', 'b']:
...
toggle_selector.ROISelector2 = RectangleSelector(ax1, onselect2, drawtype='line', interactive=True)
